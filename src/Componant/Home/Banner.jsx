...
const Banner = () => { 
    return (
        <div className='mt-5 py-5 md:mt-16 md:py-16 banner relative'>
           <div className='circle1'></div>
            <div className='flex flex-col-reverse md:flex-row md:flex py-20 px-5 primary_color_text 
            justify-between items-center '>
                
                        <div className='md:w-[900px] md:flex gap-5 items-center justify-between'>
                        <ul className='flex lg:flex-col md:fixed left-0 justify-around'>
        ...
        <p className="text-justify text-xl py-5">
            ...
            TypeScript. I love to make the web more open to the world.
                            ...
                            <button className=' btn_outline my-3 sticky'>
